...
%\todo{Let's come up with a better opening sentence. = JRB--Yes, please! (No strong feelings on what that might be=DNS)} 
...
applying
%\todo{JRB: I've given this note on all papers this week, but you need to be careful about tense. Different writing styles prefer past vs. present tense. Figure out from DS which should be used, and stick to it. DNS--Does this help? Tense is usually one of the last pieces I fix, so worth a skim through the rest of the paper to confirm that we're entirely in past} 
